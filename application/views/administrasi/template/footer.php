                ...
                <?php $list_jabatan = $this->Jabatan_m->get(); ?>
                   <script type="text/javascript">
                    window.addEventListener('DOMContentLoaded', event => {
                       ...
                       <?php foreach ($list_jabatan as $j) { ?>
                          const datatablesSimple<?=$j->id_jabatan?> = document.getElementById('datatablesSimple-<?=$j->id_jabatan?>');
                            if (datatablesSimple<?=$j->id_jabatan?>) {
                                new simpleDatatables.DataTable(datatablesSimple<?=$j->id_jabatan?>);
                            }
