    ...
    <div class="row">
      ...
      <div class="col-xl-8">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <?php echo form_open_multipart('pimpinan/proses_edit_profil'); ?>
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?= form_open_multipart('pimpinan/proses_edit_profil/') ?>
  ...
  <div class="modal fade" id="ganti" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= base_url('pimpinan/proses_edit_profil') ?>" method="Post" id="editform2">
